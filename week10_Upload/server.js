...
var uploaddb = new Datastore({ filename: "upload.db", autoload: true });
...
app.get('/NumberFacts', async (req, res) => {
    res.render('randomNumber.ejs', {})
})
...
app.post('/upload', upload.single('thefile'), function (req, res) {
    ...
    uploaddb.insert(data, function (err, newDocs) {
        console.log("err: " + err);
        console.log("newDocs: " + newDocs);
    });
    ...
    if (req.file.mimetype == "image/jpeg") {
        ...
        uploaddb.find({}, function (err, docs) {
            console.log(docs);
